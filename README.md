...
- ** Auth: ** [`better-auth`](https://github.com/m-mailaender/better-auth) + [`@mmailaender/convex-better-auth-svelte`](https://github.com/mmailaender/convex-better-auth-svelte)
