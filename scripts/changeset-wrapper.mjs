...
console.log('ℹ️  Non-interactive environment detected. Running changeset status instead of interactive prompt.');
const statusCode = run('pnpm', ['exec', 'changeset', 'status']);

if (statusCode !== 0) {
    console.warn('⚠️  changeset status could not complete in this environment (for example, missing/diverged main ref).');
